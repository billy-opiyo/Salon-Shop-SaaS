								...
								<div className="admin-gallery-grid">
									<div className="form-group full">
										...
										<input
											type="text"
											id="blogTitle"
											placeholder="e.g. How to keep knotless braids fresh"
											required
										/>
									</div>
									<div className="form-group full">
								...
								<div className="admin-gallery-grid">
									...
									>
										...
										<input
											type="text"
											id="galleryHairType"
											placeholder="e.g. 20-inch human blend"
											required
										/>
									</div>
									<div
									...
									>
										...
										<select id="galleryHairServiceType">
											<option value="">Select hair service</option>
											...
											<option value="Weaving/Extensions">
												Weaving/Extensions
											</option>
											<option value="Hair Washing & Blow Dry">
									...
									>
										...
										<input
											...
											placeholder="e.g. Silk press finish"
											required
										/>
									</div>
									<div
									...
									>
										...
										<input
											...
											placeholder="e.g. Shoulder length, thick density"
										/>
									</div>
									<div
									...
									<div className="form-group" id="galleryStylistNameGroup">
										...
										<input
											...
											placeholder="e.g. Zainab Mohamed"
											required
										/>
									</div>
									<div className="form-group full">
									...
									<div className="form-group full admin-checkbox-group">
										<label>
											...
											<span id="galleryFeaturedTrendingLabel"
												>Trending Braids</span
											>
										</label>
										<label>
											<input type="checkbox" id="galleryFeaturedMostBooked" />
											<span id="galleryFeaturedMostBookedLabel"
												>Most Booked Braids</span
											>
										</label>
									</div>
								</div>
					...
					>
						...
						<div className="admin-review-list-head">
							...
							>
								...
								<option value="status-new-first">New Status First</option>
								<option value="status-unresolved-first">
									Unresolved First
								</option>
					...
					>
						...
						<div className="admin-review-list-head">
							...
							>
								...
								<option value="date-time">Appointment date/time</option>
								<option value="status-waiting-first">Waiting first</option>
								<option value="name-az">Name (A-Z)</option>
							</select>
						</div>
									...
									<div className="form-group full">
										...
										<div className="admin-checkbox-group">
											...
											<label>
												<input
													type="checkbox"
													id="adminPermManageContent"
													checked
												/>
												<span>Manage Content</span>
											</label>
											<label>
												<input type="checkbox" id="adminPermManageSecurity" />
					...
					>
							...
							<div className="admin-review-list-head admin-security-controls-row">
								<div className="admin-security-field-group">
									...
									>
										...
										<option value="suspicious-first">Suspicious First</option>
									</select>
								</div>
						...
						<div className="admin-review-list-head" style={{marginTop: "18px"}}>
							...
							>
								...
								<option value="longest-session">Longest Session</option>
								<option value="multi-device-first">Multi-Device First</option>
							</select>
						</div>
						...
						<div className="admin-review-list-head" style={{marginTop: "18px"}}>
							...
							>
								<option value="newest">Newest</option>
								<option value="oldest">Oldest</option>
								<option value="high-first">High Severity First</option>
						...
						<div className="admin-review-list-head" style={{marginTop: "18px"}}>
							...
							>
								<option value="newest">Newest</option>
								<option value="oldest">Oldest</option>
								<option value="bookings-first">Bookings First</option>
								<option value="reviews-first">Reviews First</option>
								<option value="contact-first">Contact First</option>
							</select>
						</div>
